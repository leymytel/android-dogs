...
class DetailFragment : Fragment() {
    ...
    // FragmentDetailBinding is generated by the system
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.action_share -> {
                ...
                intent.putExtra(Intent.EXTRA_TEXT, "${currentDog?.dogBreed} bred of ${currentDog?.bredFor}")
    ...
    fun onPermissionResolved(permissionGranted: Boolean) {
        if (sendSmsStarted && permissionGranted) {
            context?.let {
                val smsInfo = SmsInfo(
                    "",
                    "${currentDog?.dogBreed} bred of ${currentDog?.bredFor}",
                    currentDog?.imageUrl
                )
